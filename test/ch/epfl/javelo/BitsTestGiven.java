...
class BitsTestGiven {
    ...
    void bitsExtractWorksOnRandomValues() {
        ...
        for (int i = 0; i < RANDOM_ITERATIONS; i += 1) {
            ...
            System.out.println("value : "+Integer.toBinaryString(value) + " start : "+ start + " length : "+length);
            System.out.println("expected U : "+Integer.toBinaryString(expectedU));
            System.out.println(Integer.toBinaryString(Bits.extractUnsigned(value, start, length)));
            System.out.println("expected S : "+Integer.toBinaryString(expectedS));
            System.out.println(Integer.toBinaryString(Bits.extractSigned(value, start, length)));
